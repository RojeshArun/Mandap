...
public class AdapterSupplierProducts extends BaseAdapter {
	...
	public AdapterSupplierProducts(Context mContext) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		mHolder.mtxtProductPrice
				.setText("Rs. :" + mdataHodler.getPriceSeller());
